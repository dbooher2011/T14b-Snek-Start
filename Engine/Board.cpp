...
void Board::DrawBoarder()
{
	...
	//top
	gfx.DrawRect(left, top, right, top + borderWidth, borderColors);

	//bottom
	gfx.DrawRect(left, bottom, right, bottom - borderWidth, borderColors);

	//left
	gfx.DrawRect(left, top + borderWidth, left + borderWidth, bottom - borderWidth, borderColors);

	//right
	gfx.DrawRect(right - borderWidth, top + borderWidth, right, bottom - borderWidth, borderColors);
}
